...
public class RoomView {
    ...
    public static void showAllRooms () {
        for (Room room : roomController.getAllRooms()) {
            ...
            System.out.println(String.format("Room %s is %s. This room is a %s.", room.getRoomNumber(), availableText, room.getRoomType()));
        }
    }

    public static void showAllAvailableRooms() {
        for (Room room : roomController.getAllAvailableRooms()) {
            System.out.println(String.format("Room %s is available. This room is a %s.", room.getRoomNumber(), room.getRoomType()));
        }
    }
